...
primeiraColuna.addEventListener('change', function() {
   ...
   else if (selectDDD.value == 12 || selectDDD.value == 13 || selectDDD.value == 14) {
     selectAT.options[0].text = "-- Atividade --";
     selectAT.options[0].value = "";
...
primeiraColuna.addEventListener('change', function() {
   ...
   } else if (selectDDDText == "Capacitação" || selectDDDText == "Demandas Extraordinárias" || selectDDDText == "Outros" || selectDDDText == "Participação em reuniões/GT" || selectDDDText == "Demandas Externas" || selectDDDText == "Demandas Extraordinárias") {
     selectPP.options[0].text = "-- Produto --";
     selectPP.options[0].value = "";
